...
$query_DetailRS1 = "SELECT invoice_date, invoice_id , c_name, address, total_bill, created_by  FROM invoice, customer where invoice.cid= customer.cid and invoice_date between '$start_date' AND '$end_date' order by invoice_date asc";
$DetailRS1 = mysqli_query($conn,$query_DetailRS1) or die(mysqli_error($conn));
//$row_DetailRS1 = mysqli_fetch_assoc($DetailRS1);

$query_DetailRS3 = "SELECT pay_date, pay_id, c_name, address, created_by, amount  FROM payment, customer where payment.cid= customer.cid  AND pay_date between '$start_date' AND '$end_date' order by pay_date asc";
						  ...
						  <tbody>
							...
							<tr>
                                ...
                                <td class="center">
									...
									<td><?php echo $row_DetailRS3['created_by']; ?></td>
                            </tr>
                              <?php }  ?>
						  </tbody>
					  </table>           
