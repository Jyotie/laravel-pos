...
$query_DetailRS1 = "SELECT * FROM customer";
...
function cid(cid)
{
 ...
 {
  window.location.href='delete_dealer.php?cid='+cid;
 }
}
</script>
</head>
		...
		<div class="row-fluid">
			...
			<div class="row-fluid sortable">
					...
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon user"></i><span class="break"></span> কাস্টমার ব্যবস্থাপনা</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<table id="example" class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
                             <?php do { ?>
							<tr>
								<td><?php echo $row_DetailRS1['c_name']; ?></td>
								<td class="center"><?php echo $row_DetailRS1['phone']; ?></td>
								<td class="center"><?php echo $row_DetailRS1['address']; ?></td>
                                <td class="center"><?php echo $row_DetailRS1['propaitor']; ?></td>
                                <td class="center"><?php echo $row_DetailRS1['area_code']; ?></td>
								
								<td class="center">

									<a class="btn btn-info" href="customer_edit.php?cid=<?php echo $row_DetailRS1['cid']; ?>">
										আপডেট 
									</a>
