...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE user SET name=%s, email=%s, pass=%s WHERE uid=%s",
						...
						<form class="form-horizontal"  name="form1" action="<?php echo $editFormAction; ?>" accept-charset="utf-8" method="post">
						  <fieldset>
							<div class="control-group">
							  ...
							  <div class="controls">
								<input name="name" type="text" class="span6 typeahead" id="name"  value="<?php echo($row_Recordset1['name']); ?>">
							  </div>
							</div>
							<div class="control-group">
							  <label class="control-label" for="email">ইমেইলঃ</label>
							  <div class="controls">
							    <input name="email" type="text" class="span6 typeahead" id="email" value="<?php echo($row_Recordset1['email']); ?>" >
						      </div>
						    </div> 
							<div class="control-group">
							  <label class="control-label" for="pass">পাসওয়ার্ড</label>
							  <div class="controls">
                                <input name="pass" rows="4" type="password" class="span6 typeahead" id="pass" value="<?php echo($row_Recordset1['pass']); ?>" >
						      </div>
						    </div>
