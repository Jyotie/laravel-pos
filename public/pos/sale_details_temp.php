...
$query_DetailRS1 = "SELECT invoice_date, invoice_id , c_name, total_bill  FROM invoice, customer where invoice.cid= customer.cid and invoice_date between '$start_date' AND '$end_date' order by invoice_date asc";
$DetailRS1 = mysqli_query($conn,$query_DetailRS1) or die(mysqli_error($conn));
$row_DetailRS1 = mysqli_fetch_assoc($DetailRS1);

$query_DetailRS3 = "SELECT pay_date, pay_id, c_name, amount  FROM payment, customer where payment.cid= customer.cid  AND pay_date between '$start_date' AND '$end_date' order by pay_date asc";
...
$myFormatForView2 = date("d/m/y", $time2);echo convertbn($myFormatForView2);?> <?php 
								$bill_query = mysqli_query($conn,"SELECT sum(total_bill) as bill, count(invoice_id) as nos FROM invoice WHERE invoice_date between '$start_date' AND '$end_date'") or die(mysqli_error($conn));
							...
							<tr>
                                ...
                                <td class="center">
									<?php  echo convertbn($row_DetailRS1['invoice_id']); ?> </td>
                                     <td class="center">
									<?php  echo convertbn($row_DetailRS1['c_name']); ?> </td>
...
<?php 
								$paid_query = mysqli_query($conn,"SELECT sum(amount) as paid, count(pay_id) as nos FROM payment WHERE  pay_date between '$start_date' AND '$end_date'") or die(mysqli_error($conn));
    			...
    			<table class="table table-striped table-bordered bootstrap">
						  ...
						  <tbody>
							...
							<tr>
                                ...
                                <td class="center">
									<?php  echo convertbn($row_DetailRS3['c_name']); ?> </td>
                                          <td class="center">
